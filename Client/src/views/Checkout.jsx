...
const Checkout = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Guardamos los datos para mostrarlos en la página de confirmación
  ...
  // Dinámicamente encendemos los pasos a medida que el usuario completa la información
        ...
        <form onSubmit={handleSubmit} className="checkout__main" noValidate>
          ...
          <section className="checkout__seccion">
            ...
            <div className="checkout__form-fields">
              ...
              {/* Ciudad y Código Postal (Lado a lado) */}
          ...
          <section className="checkout__seccion">
            ...
            <div className="checkout__form-fields">
              ...
              {/* Fecha Vencimiento y CVV (Lado a lado) */}
              <div className="checkout__row-2">
                <div className="checkout__field">
                  <Input
          ...
          <div className="checkout__acciones">
            ...
            {/* Certificado de Transacción Segura */}
